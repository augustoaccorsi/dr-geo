...
export default function Contact() {
  ...
  const inputCls =
    'w-full bg-neutral-50 dark:bg-white/5 border border-neutral-200 dark:border-white/10 rounded-lg px-3.5 py-2.5 text-sm text-neutral-900 dark:text-white placeholder-neutral-400 dark:placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-neutral-900 dark:focus:ring-white/30 focus:border-transparent transition-all'

  return (
    <section id="contact" className="bg-[#F5F5F5] dark:bg-[#161210] py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="mb-16">
          <p className="text-xs font-medium tracking-[0.18em] uppercase text-amber-600 mb-5">
            {t('contact.hero.tagline')}
          </p>
          <h2 className="text-4xl lg:text-5xl font-medium tracking-[-0.03em] text-neutral-900 dark:text-white leading-[1.1] whitespace-pre-line">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          {/* Form */}
          <div className="lg:col-span-2 bg-white dark:bg-[#231F1A] rounded-2xl p-8">
            <h3 className="text-base font-medium tracking-tight dark:text-white mb-1">
              {t('contact.form.title')}
            </h3>
            <p className="text-sm text-neutral-500 dark:text-neutral-400 tracking-tight mb-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-medium tracking-wide text-neutral-500 dark:text-neutral-400 mb-1.5">
          ...
          <div className="space-y-4">
            <div className="bg-white dark:bg-[#231F1A] rounded-2xl p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium tracking-tight dark:text-white break-all">{CONTACT_EMAIL}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium tracking-tight dark:text-white">{t('contact.info.hours_value')}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium tracking-tight dark:text-white">{t('contact.info.hq_value')}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <TbMapPin size={16} className="text-neutral-400 mt-0.5 shrink-0" />
                  <div>
                    ...
                    <p className="text-sm font-medium tracking-tight dark:text-white">{t('contact.info.field_coverage')}</p>
                  </div>
                </div>
              </div>
            </div>
