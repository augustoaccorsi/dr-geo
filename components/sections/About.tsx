...
export default function About() {
  ...
  return (
    <section id="about" className="bg-[#F5F5F5] py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-5 mb-20">
          {cards.map(({ Icon, titleKey, descKey }) => (
            <div
              key={titleKey}
              className="bg-white rounded-2xl p-7 border border-neutral-100 hover:border-neutral-200 transition-colors"
            >
              <div className="w-10 h-10 bg-neutral-100 rounded-xl flex items-center justify-center mb-6">
