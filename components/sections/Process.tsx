      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {steps.map(({ num, titleKey, descKey }) => (
            <div
              key={num}
              className="border border-white/10 rounded-2xl p-7 hover:border-white/20 transition-colors"
            >
              <p className="text-5xl font-medium tracking-[-0.04em] text-white/15 mb-8 select-none">
                {num}
              </p>
